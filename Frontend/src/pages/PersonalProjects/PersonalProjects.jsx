  ...
  return (
    <div className='flex flex-col items-center dark:bg-zinc-900'>
      ...
      <div className='flex gap-5  items-center mt-5 dark:bg-zinc-800 pt-8 pb-8'>
        <div className='flex justify-center items-center md:h-20 md:w-20 h-16 w-16   bg-purple-600 rounded-full text-4xl font-semibold text-white ml-5'>P</div>
        <h1 className='md:text-4xl font-bold text-white text-2xl'>Pranit More Marathi</h1>
      </div>
          ...
          <section className="w-full md:w-[45%] border-t md:border-l md:border-t-0 border-zinc-200 dark:border-zinc-700 p-6">
            <div className="space-y-6">
              ...
              <p className="text-zinc-600 dark:text-zinc-300 leading-relaxed">
                ...
                technologies and best practices, this showcase represents weeks
                of dedicated development and thoughtful user experience
                considerations.
              </p>
